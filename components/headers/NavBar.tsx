                    ...
                    <ul className='flex gap-3 text-slate-500'>
                        {
                            navRoutes.map((route, index) => {
                                return <li
                                    className={`hover:!border-b-4 border-b-transparent hover:!border-primary-blurple ${window.location.pathname == route.path ? '!border-primary-blurple !border-b-4' : null}`}
                                    key={index}
                    ...
                    {/* Side Bar */}
                    {
                        isOpen ? (
                            <motion.aside initial={{ width: 0 }}
                                animate={{ width: '90%' }} className='fixed z-10 bg-ternary top-0 right-0 h-screen p-6'>
                                {/* Branding */}
